...
void PlatAuMenu::afficher_sommaire(ostream & os) const	{
	if (TRACE_Plats){
...
void PlatAuMenu::set_prix(double p) {
	if (TRACE_Plats){
...
void PlatAuMenu::set_code(int  c) {
	if (TRACE_Plats){
...
void PlatAuMenu::set_desc(string s) {
	if (TRACE_Plats){
...
double PlatAuMenu::get_prix() const {
	if (TRACE_Plats){
...
string PlatAuMenu::get_desc() const {
	if (TRACE_Plats){
		cout << "PlatAuMenu::set_desc " << endl;
	}
	return desc;
