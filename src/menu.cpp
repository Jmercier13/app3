...
void Menu::afficher_courant(ostream & os) const {
	if (TRACE_Menu){
...
/**
	...
	\return void
*/
void Menu::ajoute(int code, string desc, double prix) {
	if (TRACE_Menu){
		cout << "Menu::ajoute, courant = " << courant << endl;
	}
